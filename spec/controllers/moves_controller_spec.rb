...
RSpec.describe MovesController, type: :controller do
  ...
  let(:valid_attributes) {
    build(:move).attributes.symbolize_keys
  }

  let(:invalid_attributes) {
    build(:move, :invalid).attributes.symbolize_keys
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        build(:move, :new).attributes.symbolize_keys
      }
      ...
      it "updates the requested move" do
        ...
        move.reload
        expect(move.summary).to eq(new_attributes[:summary])
      end
