module ExercisesHelper
  def board_square(rank, file, setup) #creates a board square and puts a piece in it if setup says it should have one
  ...
  def piece_square(piece_color, piece_id, piece_html, used_pieces)
    content_tag(:div, "", class: "square") do
      content_tag(:div, piece_html.html_safe, class: "piece #{piece_color}", id: piece_id) unless used_pieces.include? piece_id
    end
  end
